...
private:
    ...
    const ModToggle::Ptr m_motion_control_aiming{ ModToggle::create(generate_name("MotionControlAiming"), false) };
    const ModSlider::Ptr m_motion_control_smoothing{ ModSlider::create(generate_name("MotionControlSmoothing"), 0.0, 1.0, 0.5) };


    ValueList m_options{*m_dominant_eye, *m_head_tracking_multiplier, *m_head_tracking_type, *m_taa_anf_nvidia_fix, *m_disable_zoom, *m_hud_scale, *m_hud_perspective, *m_alternative_joy_layout, *m_decoupled_pitch, *m_pawn_control_rotation, *m_snap_turn, *m_snap_turn_angle, *m_motion_control_aiming, *m_motion_control_smoothing };
};
